...
namespace TicketSystem.API.Background
{
    public class LoadDataProcess : IHostedService
    {
        ...
        public Task StartAsync(CancellationToken cancellationToken)
        {
            ...
            LoadData<Dictionary<RoleType, List<PermissionType>>>(Path.Combine(this._env.ContentRootPath, "Data", "Permissions.json"), Constant.Permissions);
            LoadData<Dictionary<RoleType, List<TicketType>>>(Path.Combine(this._env.ContentRootPath, "Data", "TicketType.json"), Constant.TicketType);
